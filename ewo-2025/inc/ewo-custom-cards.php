<?php
/**
 * EWO Custom Homepage Cards — admin CRUD and frontend helpers.
 *
 * @package EWO_2025
 */
...
function ewo_2025_cc_admin_menu() {
	add_submenu_page(
		'ewo-settings',
		__( 'Custom Cards', 'ewo-2025' ),
		__( 'Custom Cards', 'ewo-2025' ),
		'manage_options',
		'ewo-custom-cards',
		'ewo_2025_cc_render_page'
	);
}
add_action( 'admin_menu', 'ewo_2025_cc_admin_menu' );
