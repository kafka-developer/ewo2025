...
function ewo_2025_fv_render_page() {
	...
	$disabled_count = count( $features ) - $enabled_count;
	...
	<div id="ewo-fv-page">
		...
		<div class="fv-stats">
			<div class="fv-stat">
				<div class="fv-stat__num"><?php echo esc_html( (string) count( $features ) ); ?></div>
				<div class="fv-stat__lbl"><?php esc_html_e( 'Total Features', 'ewo-2025' ); ?></div>
			</div>
			<div class="fv-stat">
				<div class="fv-stat__num fv-stat__num--g"><?php echo esc_html( (string) $enabled_count ); ?></div>
