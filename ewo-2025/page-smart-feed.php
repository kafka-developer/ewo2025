...
if ( ! ewo_2025_feature_enabled( 'smart_feed' ) ) {
	echo '<main id="primary" class="site-main" style="background:#060f1e;min-height:60vh;display:flex;align-items:center;justify-content:center;">';
	if ( current_user_can( 'manage_options' ) ) {
		echo '<p style="color:#6b88b5;font-size:.9rem;">Smart Feed page is currently disabled via <a href="' . esc_url( admin_url( 'admin.php?page=ewo-feature-visibility' ) ) . '" style="color:#d7a84b;">Feature Visibility</a>.</p>';
	}
	echo '</main>';
	get_footer();
	return;
